...
# can't be a legitimate limra collection name.
...
class MilvusClient(VectorDBBase):
    ...
    def _get_collection_and_resource_id(self, collection_name: str) -> Tuple[str, str]:
        ...
        WARNING: This mapping relies on current limra naming conventions for
        collection names. If limra changes how it generates collection names
