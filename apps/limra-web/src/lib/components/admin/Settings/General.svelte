		...
		{#if adminConfig !== null}
			<div class="">
						...
						<div class="flex w-full justify-between items-center">
							<div class="text-xs pr-2">
								...
								<div class=" text-xs text-gray-500">
									{$i18n.t('Discover how to use limra and seek support from the community.')}
								</div>
							</div>
						...
						<div class="mt-1">
							<div class="flex space-x-1">
								<a href="https://discord.gg/5rJgQTnV4s" target="_blank">
									<img
										alt="Discord"
										src="https://img.shields.io/badge/Discord-limra-blue?logo=discord&logoColor=white"
									/>
								</a>
								...
								<a href="https://twitter.com/limra" target="_blank">
									<img
										...
										src="https://img.shields.io/twitter/follow/limra"
									/>
								</a>
				...
				<div class="mb-3">
					...
					<div class="mb-2.5 w-full justify-between">
						<div class="flex w-full justify-between">
							<div class=" self-center text-xs font-medium">{$i18n.t('limra URL')}</div>
						</div>
						...
						<div class="mt-2 text-xs text-gray-400 dark:text-gray-500">
							{$i18n.t(
								'Enter the public URL of your limra. This URL will be used to generate links in the notifications.'
							)}
						</div>
					</div>
