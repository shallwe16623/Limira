...
CREATE TABLE IF NOT EXISTS limra_task_event_logs (
...
CREATE INDEX IF NOT EXISTS idx_limra_task_event_logs_task_created
    ON limra_task_event_logs (task_id, created_at DESC);
