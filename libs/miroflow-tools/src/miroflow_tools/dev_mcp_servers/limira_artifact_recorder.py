...
from miroflow_tools.limira_artifacts import record_research_artifact_json


mcp = FastMCP("limira_artifact_recorder")
...
async def record_research_artifact(
    ...
    """
    Record a structured limira OSINT artifact without failing the research task.
    ...
    Returns:
        Compact JSON event. Valid records return a typed limira artifact event; invalid records return a non-fatal artifact_warning event.
    """
